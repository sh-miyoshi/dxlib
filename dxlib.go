...
//dxlib int Set3DPositionSoundMem(VECTOR position, int soundHandle)
//dxlib int Set3DRadiusSoundMem(float radius, int soundHandle)
//dxlib int Set3DVelocitySoundMem(VECTOR velocity, int soundHandle)
//dxlib int SetNextPlay3DPositionSoundMem(VECTOR position, int soundHandle)
//dxlib int SetNextPlay3DRadiusSoundMem(float radius, int soundHandle)
//dxlib int SetNextPlay3DVelocitySoundMem(VECTOR velocity, int soundHandle)
...
//dxlib int Set3DSoundListenerPosAndFrontPos_UpVecY(VECTOR position, VECTOR frontPosition)
//dxlib int Set3DSoundListenerPosAndFrontPosAndUpVec(VECTOR position, VECTOR frontPosition, VECTOR upVector)
//dxlib int Set3DSoundListenerVelocity(VECTOR velocity)
